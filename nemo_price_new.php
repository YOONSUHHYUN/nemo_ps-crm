...
"</thead>";
      ...
      <center><div class="bannerbox">
  <img src="banner/banner03.png" >
 <img src="banner/banner04.png" >
</div></center>
...
<body>
        ...
        <div class="row">
          <div class="col-xs-12">
            <!-- 반응형 이미지 -->
            <img src="banner/bg_img04.jpg" class="img-responsive img-full-width" alt="배너 이미지">
            <img src="banner/bg_img02.jpg" class="img-responsive img-full-width" alt="배너 이미지">
          </div>
        </div>
      </div>
      ...
      <body>
        ...
        <div class="row">
          <div class="col-xs-12">
            <!-- 반응형 이미지 -->
            <img src="banner/bg_img03.jpg" class="img-responsive img-full-width" alt="배너 이미지">
          </div>
        </div>
      </div>
      ...
      <center><a href="https://forms.gle/XJtR5sRYq6vBLDfA7" target="_blank"><img
      src="button_01.png"
      alt="문의하기" ></a></center>
