...
<html>
  ...
  <title>상품추가 업체 일반금액</title>
  </head>
  <body>
    <h1><center>상품추가 업체 상품금액</center></h1>

  <h3><center><td colspan="3"><?php echo $_GET['address1']." ".$address; ?></td> 상품금액</center></h3>
<h3><center>기간 : <?php

echo $today;
?> ~ <?php echo $row11['enddate']; ?> (<?php echo $row81['usedays']; ?>일) </center></h3>




<h3><center>일반매물 금액</center></h3>
    ...
    <h3><center>프리미엄 (우선노출) 상품 금액</center></h3>
