...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (isset($_POST["button1"])){
    ...
    $sql = "UPDATE target SET 업체명='$companyName', 대표자명='$ceoName', 시도='$city', 시군구='$district' WHERE num='$num'";
...
if ($result->num_rows > 0) {
    ...
    echo "<table>";
    echo "<tr><th>num</th><th>업체명</th><th>대표자명</th><th>연락처</th><th>시도</th><th>시군구</th></tr>";
    echo "<tr>";
    echo "<td>$num</td>";
