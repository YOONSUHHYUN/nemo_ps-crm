      ...
      <tr>
        ...
        <td>
          ...
          if (isset($_POST['submit'])) {
              ...
              // Prepare the SQL query
              $queryjina = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                          FROM agent
                          WHERE `담당자`='이지나' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

              // Execute the query
              $resultjina = $conn->query($queryjina);

              if ($resultjina->num_rows > 0) {
                  // Output data of the first row
                  $rowjina = $resultjina->fetch_assoc();
                  $contact_countjina = $rowjina['contact_count'];

                  echo " $contact_countjina";
              } else {
                  echo "No contacts found on $selected_date";
              }
                }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjina2 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `수신`='문자' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjina2 = $conn->query($queryjina2);

                  if ($resultjina2->num_rows > 0) {
                      // Output data of the first row
                      $rowjina2 = $resultjina2->fetch_assoc();
                      $contact_countjina2 = $rowjina2['contact_count'];

                      echo " $contact_countjina2 ";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  $queryjina2 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `수신`='성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";
        ...
        <td>
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjina3 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `회사소개`='성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjina3 = $conn->query($queryjina3);

                  if ($resultjina3->num_rows > 0) {
                      // Output data of the first row
                      $rowjina3 = $resultjina3->fetch_assoc();
                      $contact_countjina3 = $rowjina3['contact_count'];

                      echo " $contact_countjina3 ->";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
          ...
          <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjina4 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `상품소개`='성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjina4 = $conn->query($queryjina4);

                  if ($resultjina4->num_rows > 0) {
                      // Output data of the first row
                      $rowjina4 = $resultjina4->fetch_assoc();
                      $contact_countjina4 = $rowjina4['contact_count'];

                      echo " $contact_countjina4 ->";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
          ...
          <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjina5 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `결제여부`='성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjina5 = $conn->query($queryjina5);

                  if ($resultjina5->num_rows > 0) {
                      // Output data of the first row
                      $rowjina5 = $resultjina5->fetch_assoc();
                      $contact_countjina5 = $rowjina5['contact_count'];

                      echo " $contact_countjina5";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
      ...
      <tr>
        ...
        <td>
          ...
          if (isset($_POST['submit'])) {
              ...
              // Prepare the SQL query
              $queryjung = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                          FROM agent
                          WHERE `담당자`='정종형' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

              // Execute the query
              $resultjung = $conn->query($queryjung);

              if ($resultjung->num_rows > 0) {
                  // Output data of the first row
                  $rowjung = $resultjung->fetch_assoc();
                  $contact_countjung = $rowjung['contact_count'];

                  echo " $contact_countjung";
              } else {
                  echo "No contacts found on $selected_date";
              }
                  }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung2 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `수신`='문자' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjung2 = $conn->query($queryjung2);

                  if ($resultjung2->num_rows > 0) {
                      // Output data of the first row
                      $rowjung2 = $resultjung2->fetch_assoc();
                      $contact_countjung2 = $rowjung2['contact_count'];

                      echo " $contact_countjung2";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  $queryjung2 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `수신`='성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung3 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `회사소개`='성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjung3 = $conn->query($queryjung3);

                  if ($resultjung3->num_rows > 0) {
                      // Output data of the first row
                      $rowjung3 = $resultjung3->fetch_assoc();
                      $contact_countjung3 = $rowjung3['contact_count'];

                      echo " $contact_countjung3 ->";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung4 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `상품소개`='성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjung4 = $conn->query($queryjung4);

                  if ($resultjung4->num_rows > 0) {
                      // Output data of the first row
                      $rowjung4 = $resultjung4->fetch_assoc();
                      $contact_countjung4 = $rowjung4['contact_count'];

                      echo " $contact_countjung4 ->";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung5 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `결제여부`='성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjung5 = $conn->query($queryjung5);

                  if ($resultjung5->num_rows > 0) {
                      // Output data of the first row
                      $rowjung5 = $resultjung5->fetch_assoc();
                      $contact_countjung5 = $rowjung5['contact_count'];

                      echo " $contact_countjung5";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
      ...
      <tr>
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjina7 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `현상태`='관리1' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjina7 = $conn->query($queryjina7);

                  if ($resultjina7->num_rows > 0) {
                      // Output data of the first row
                      $rowjina7 = $resultjina7->fetch_assoc();
                      $contact_countjina7 = $rowjina7['contact_count'];

                      echo " $contact_countjina7";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
        ...
        <td>
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjina8 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `현상태`='관리2' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjina8 = $conn->query($queryjina8);

                  if ($resultjina8->num_rows > 0) {
                      // Output data of the first row
                      $rowjina8 = $resultjina8->fetch_assoc();
                      $contact_countjina8 = $rowjina8['contact_count'];

                      echo " $contact_countjina8";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
          ...
          <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjina9 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `현상태`='관리3' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjina9 = $conn->query($queryjina9);

                  if ($resultjina9->num_rows > 0) {
                      // Output data of the first row
                      $rowjina9 = $resultjina9->fetch_assoc();
                      $contact_countjina9 = $rowjina9['contact_count'];

                      echo " $contact_countjina9";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
          ...
          <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjina10 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='이지나' AND `현상태`='결제성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjina10 = $conn->query($queryjina10);

                  if ($resultjina10->num_rows > 0) {
                      // Output data of the first row
                      $rowjina10 = $resultjina10->fetch_assoc();
                      $contact_countjina10 = $rowjina10['contact_count'];

                      echo " $contact_countjina10";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
      ...
      <tr>
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung7 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `현상태`='관리1' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjung7 = $conn->query($queryjung7);

                  if ($resultjung7->num_rows > 0) {
                      // Output data of the first row
                      $rowjung7 = $resultjung7->fetch_assoc();
                      $contact_countjung7 = $rowjung7['contact_count'];

                      echo " $contact_countjung7";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung8 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `현상태`='관리2' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjung8 = $conn->query($queryjung8);

                  if ($resultjung8->num_rows > 0) {
                      // Output data of the first row
                      $rowjung8 = $resultjung8->fetch_assoc();
                      $contact_countjung8 = $rowjung8['contact_count'];

                      echo " $contact_countjung8";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung9 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `현상태`='관리3' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjung9 = $conn->query($queryjung9);

                  if ($resultjung9->num_rows > 0) {
                      // Output data of the first row
                      $rowjung9 = $resultjung9->fetch_assoc();
                      $contact_countjung9 = $rowjung9['contact_count'];

                      echo " $contact_countjung9";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung10 = "SELECT count(DATE_FORMAT(`컨택일`, '%Y-%m-%d')) AS contact_count
                            FROM agent
                            WHERE `담당자`='정종형' AND `현상태`='결제성공' AND DATE_FORMAT(`컨택일`, '%Y-%m-%d') = '$selected_date'";

                  // Execute the query
                  $resultjung10 = $conn->query($queryjung10);

                  if ($resultjung10->num_rows > 0) {
                      // Output data of the first row
                      $rowjung10 = $resultjung10->fetch_assoc();
                      $contact_countjung10 = $rowjung10['contact_count'];

                      echo " $contact_countjung10";
                  } else {
                      echo "No contacts found on $selected_date";
                  }
              }
