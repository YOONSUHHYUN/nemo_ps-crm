      ...
      <tr>
        ...
        <td>
              ...
              if (isset($_POST['submit'])) {
                  ...
                  $query = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
  ...
  <td>
      ...
      <td>
            ...
            if (isset($_POST['submit'])) {
                ...
                // Prepare the SQL query
                $queryda = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
      ...
      <tr>
        ...
        <td>
          ...
          if (isset($_POST['submit'])) {
              ...
              // Prepare the SQL query
              $queryhyo = "SELECT COUNT(DISTINCT num) AS contact_count
                          FROM agent
        ...
        <td>
          ...
          if (isset($_POST['submit'])) {
              ...
              // Prepare the SQL query
              $queryjung = "SELECT COUNT(DISTINCT num) AS contact_count
                          FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung2 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung3 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung4 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung5 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
      ...
      <tr>
        ...
        <td>
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryhyun7 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
          ...
          <td>
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryhyun8 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
          ...
          <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryhyun9 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
          ...
          <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryhyun10= "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
      ...
      <td>이다영</td>
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryda7 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
            ...
            <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryda8 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
            ...
            <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryda9 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
            ...
            <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryda10 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
      ...
      <tr>
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryhyo7 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryhyo8 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryhyo9 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryhyo10 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
      ...
      <tr>
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung7 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung8 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung9 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
        ...
        <?php
              ...
              if (isset($_POST['submit'])) {
                  ...
                  // Prepare the SQL query
                  $queryjung10 = "SELECT COUNT(DISTINCT num) AS contact_count
                            FROM agent
