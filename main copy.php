...
.nav-link{
  ...
  <a>CRM.. beta version 1.0 / 2023-10-16</a>
      ...
      <div class="row d-flex align-items-stretch">
        ...
        >
          <ul class="nav flex-column"></br>
            ...
            <li class="nav-item">
              <a class="nav-link" href="javascript:void(0);" onclick="changeIframeSrc('https://admin.nemoapp.kr/ArticleItem/AgentItemIndex');"><i class="material-icons">paid</i><span>&nbsp;환불금액조회</span></a>
            </li>
