      ...
      <thead>
        <tr>
          <th scope="col" style='text-align: center; vertical-align : middle;'>지역</th>
           <td colspan="3"><?php echo $_GET['address1']." ".$address; ?></td>
...
-[5월 잔여(<?php echo number_format($row3['sdprice']); ?>원X<?php echo $row4['startdays']; ?>일)+1개월(<?php echo number_format($row2['cp']); ?>원)]X입점할인30%=<?php echo number_format($row10['newnormalprice']); ?>원
